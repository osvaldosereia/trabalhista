...
export const FFP = [
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a prestação de serviços sem anotação em CTPS, com base nos documentos anexados (CTPS, holerites, mensagens e comunicações). Detalhe as atividades exercidas, jornada, salário e subordinação, seguindo o padrão da Justiça do Trabalho. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a relação de trabalho disfarçada de prestação de serviços via pessoa jurídica, destacando elementos de pessoalidade, habitualidade, subordinação e onerosidade. Utilize linguagem técnica e descreva a fraude na contratação. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Vínculo e registro"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a terceirização irregular da atividade-fim, apontando o vínculo direto com a tomadora. Destaque subordinação, controle hierárquico e integração às atividades permanentes da empresa. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Vínculo e registro"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o estágio irregular, informando ausência de acompanhamento pedagógico, controle de jornada e inserção plena nas atividades da empresa. Fundamente que a relação se enquadra nos requisitos de vínculo empregatício. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Vínculo e registro"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a prorrogação indevida do contrato de experiência além do limite de 90 dias, demonstrando a continuidade do vínculo e a descaracterização do prazo determinado. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Vínculo e registro"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a ausência de controle de jornada pelo empregador, mencionando a rotina de trabalho e a frequência de horas extras realizadas. Aponte a presunção favorável ao empregado conforme Súmula 338/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Vínculo e registro"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DO VÍNCULO DE EMPREGO' abordando todas as hipóteses possíveis (CTPS não anotada, pejotização, terceirização ilícita, estágio fraudulento, prorrogação irregular de contrato e ausência de registro de jornada). Desenvolva o texto com base nas provas anexadas, descrevendo de forma clara as circunstâncias de prestação de serviços, a subordinação e a habitualidade, com base na CLT, Constituição Federal e Súmulas do TST.",
    "artigosRelacionados": [
      "Art. 2º, 3º, 29, 445, 451 e 74 da CLT",
      "Art. 7º, I e XIII da CF/88",
      "Súmulas 212, 331, 338 e 363 do TST"
    ],
    "categoria": "Vínculo e registro"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático narrando a dispensa sem justa causa do reclamante, descrevendo a data, ausência de aviso prévio trabalhado, falta de pagamento correto das verbas rescisórias e prejuízos decorrentes. Utilize linguagem forense e formal, baseando-se em comprovantes de salário e comunicações internas. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a dispensa discriminatória sofrida pelo reclamante, especificando o motivo e os indícios de discriminação (doença, idade, gravidez ou represália). Destaque o abalo moral e a violação dos princípios constitucionais. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as faltas graves cometidas pelo empregador (como atrasos salariais, ausência de depósitos de FGTS ou assédio moral), que motivaram o pedido de rescisão indireta. Detalhe as consequências ao trabalhador e o término do contrato. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a dispensa por justa causa aplicada de forma indevida, indicando a ausência de provas, o abuso disciplinar e a violação da proporcionalidade. Fundamente a injustiça da penalidade e seus reflexos sobre o trabalhador. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o atraso no pagamento das verbas rescisórias, informando as datas da dispensa e do efetivo pagamento, e os prejuízos materiais enfrentados pelo reclamante. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a ausência de entrega dos documentos rescisórios (TRCT, guias de FGTS e seguro-desemprego), apontando os prejuízos sofridos e a resistência do empregador. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as circunstâncias em que o reclamante foi compelido a assinar pedido de demissão sob coação ou pressão, destacando a ausência de espontaneidade e a violação da boa-fé. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Rescisão e verbas"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo 'DA RESCISÃO CONTRATUAL E DAS VERBAS DEVIDAS', abordando todas as hipóteses possíveis: dispensa sem justa causa, dispensa discriminatória, rescisão indireta, justa causa indevida, atraso ou irregularidade no pagamento e entrega de documentos. Fundamente com base na CLT, Constituição Federal e Súmulas do TST, descrevendo os fatos de forma cronológica e técnica, e relacionando cada irregularidade às verbas correspondentes.",
    "artigosRelacionados": [
      "Arts. 477, 482, 483 e 487 da CLT",
      "Lei 8.036/90 — FGTS",
      "Lei 9.029/95 — dispensa discriminatória",
      "Súmulas 32, 212, 330, 350 e 443 do TST"
    ],
    "categoria": "Rescisão e verbas"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a jornada habitual do reclamante, informando o horário de entrada, saída, pausas e dias trabalhados, conforme os documentos anexados (cartões de ponto, escalas e comunicações). Mencione a ausência de pagamento correto das horas extras e seus reflexos. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a supressão do intervalo intrajornada, indicando o tempo efetivamente usufruído, as ordens da chefia e a ausência de condições adequadas para refeição e descanso. Fundamente conforme art. 71 da CLT e Súmula 437 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Jornada de trabalho"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a frequência de trabalho em domingos e feriados, indicando a ausência de folgas compensatórias e os registros de jornada anexados. Destaque a habitualidade e a ausência de pagamento em dobro. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Jornada de trabalho"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a permanência do reclamante em regime de sobreaviso ou prontidão, explicando o uso de celular, escalas de plantão e limitações à vida pessoal. Fundamente com base no art. 244 da CLT e Súmula 428 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Jornada de trabalho"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o tempo gasto diariamente para troca de uniformes, deslocamento interno e registro de ponto, apontando a habitualidade e ausência de pagamento. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Jornada de trabalho"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a jornada realizada em turnos de revezamento, destacando a alternância de horários e os prejuízos à saúde e ao convívio social. Fundamente conforme art. 7º, XIV, CF/88 e Súmula 360/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Jornada de trabalho"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DA JORNADA DE TRABALHO', incluindo as hipóteses de excesso de jornada, horas extras não pagas, intervalos suprimidos, labor em domingos e feriados, sobreaviso e tempo à disposição. Estruture em parágrafos claros e técnicos, com base nas provas anexadas e nos registros de jornada. Fundamente conforme CLT, CF/88 e jurisprudência do TST, sempre com linguagem forense precisa e objetiva.",
    "artigosRelacionados": [
      "Arts. 4º, 58, 59, 71 e 244 da CLT",
      "Art. 7º, XIII, XIV, XV e XVI da CF/88",
      "Súmulas 85, 146, 360, 366, 428 e 437 do TST"
    ],
    "categoria": "Jornada de trabalho"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as condições insalubres enfrentadas pelo reclamante, detalhando os agentes nocivos (calor, ruído, produtos químicos etc.) e os documentos anexados (laudos, PPP, ASO). Fundamente nos arts. 189 e 192 da CLT e NR-15 do MTE. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a exposição do reclamante a agentes perigosos, como inflamáveis, eletricidade ou explosivos, mencionando documentos anexados (PPP, LTCAT, laudos). Fundamente conforme art. 193 da CLT e NR-16. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as atividades extras executadas pelo reclamante além das originalmente contratadas, com base em provas anexadas (testemunhos, organogramas, comunicações internas). Destaque a habitualidade e a ausência de contraprestação adequada. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o desvio funcional do reclamante, apontando as funções efetivamente desempenhadas e os documentos anexados (fichas de registro, relatórios, depoimentos). Fundamente no art. 460 da CLT e Súmula 125 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a equiparação salarial pleiteada, indicando o paradigma, funções exercidas, tempo de serviço e produtividade, conforme documentos anexados (fichas, holerites, depoimentos). Fundamente conforme art. 461 da CLT e Súmula 6 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o labor noturno habitual, indicando horários e ausência de pagamento correto. Utilize provas anexadas (cartões de ponto, recibos, mensagens). Fundamente conforme art. 73 da CLT e Súmula 60 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a retirada indevida do adicional de insalubridade ou periculosidade, apontando que não houve alteração nas condições de trabalho. Fundamente conforme Súmula 248/TST e art. 468 da CLT. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Adicionais e condições"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DOS ADICIONAIS E DAS CONDIÇÕES DE TRABALHO', incluindo insalubridade, periculosidade, acúmulo e desvio de função, equiparação e adicionais suprimidos. Estruture tecnicamente conforme CLT, NR-15, NR-16 e jurisprudência do TST. O texto deve detalhar as condições de trabalho com base nas provas anexadas, em tom impessoal, técnico e forense.",
    "artigosRelacionados": [
      "Arts. 189, 192, 193, 456, 460, 461, 468 e 73 da CLT",
      "NR-15 e NR-16 do MTE",
      "Súmulas 6, 60, 80, 125, 248, 364 e 372 do TST"
    ],
    "categoria": "Adicionais e condições"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as condutas abusivas praticadas contra o reclamante (humilhações, xingamentos, isolamento, ameaças), indicando datas, testemunhas e provas anexadas (mensagens, gravações, relatos). Fundamente no art. 1º, III, CF/88 e art. 483 da CLT. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o assédio sexual sofrido pelo reclamante, indicando a hierarquia, a frequência dos atos, as provas anexadas (mensagens, e-mails, testemunhos) e o impacto emocional. Fundamente conforme art. 216-A do CP e art. 483 da CLT. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Danos morais e saúde"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a doença ocupacional diagnosticada (ex: LER/DORT, depressão, hérnia), as condições do ambiente e as provas anexadas (ASO, CAT, laudos, atestados). Fundamente conforme Lei 8.213/91 e CLT. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Danos morais e saúde"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o acidente de trabalho (data, local, lesão, consequências) e as provas anexadas (CAT, laudos, fotos, atestados). Fundamente conforme Lei 8.213/91 e CF/88. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Danos morais e saúde"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo as condições psicológicas adversas do ambiente laboral, como pressão excessiva, sobrecarga, humilhações ou falta de suporte, citando documentos anexados (atestados, relatórios médicos, comunicações internas). Fundamente conforme CF/88, CLT e NR-17. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Danos morais e saúde"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a negligência no exame médico ocupacional (ausência de exame admissional, periódico ou demissional), indicando consequências à saúde do reclamante e documentos anexados (ASO, laudos, comunicações). Fundamente conforme CLT e Código Civil. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Danos morais e saúde"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DOS DANOS MORAIS E SAÚDE OCUPACIONAL', abrangendo assédio moral, assédio sexual, doença ocupacional, acidente típico e ambiente degradante. Descreva os fatos de forma técnica e sensível, com base nos documentos anexados (CAT, ASO, laudos, mensagens). Fundamente conforme CF/88, CLT, Lei 8.213/91 e precedentes do TST e STF, mantendo rigor técnico e linguagem jurídica impessoal.",
    "artigosRelacionados": [
      "Arts. 157, 168 e 483 da CLT",
      "Arts. 19 e 20 da Lei 8.213/91",
      "Art. 1º, III e Art. 7º, XXII e XXVIII da CF/88",
      "Art. 927 do Código Civil",
      "Súmulas 229/STF e 378/TST"
    ],
    "categoria": "Danos morais e saúde"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático narrando a dispensa da reclamante durante a gestação, indicando o período gestacional e os documentos anexados (atestados, exames, comunicações). Fundamente no art. 10, II, 'b', do ADCT e Súmula 244 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o acidente sofrido pelo reclamante, o afastamento previdenciário e o término do benefício, com base nos documentos anexados (CAT, atestados, comunicações). Fundamente conforme Lei 8.213/91 e Súmula 378 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Estabilidades e garantias"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a dispensa do reclamante no exercício do mandato sindical, indicando a data da eleição e do registro da candidatura. Fundamente conforme art. 543 da CLT e Súmula 369 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Estabilidades e garantias"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a dispensa do reclamante após readaptação profissional por motivo de acidente, citando documentos anexados (laudos, CAT, ASO). Fundamente conforme Lei 8.213/91 e Súmula 378/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Estabilidades e garantias"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a dispensa do reclamante em período pré-aposentadoria previsto em norma coletiva, indicando a data de admissão, tempo de serviço e proximidade da aposentadoria. Fundamente conforme a CCT e jurisprudência do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Estabilidades e garantias"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o afastamento médico e a dispensa posterior, indicando as datas e documentos anexados (atestados, comunicações, laudos). Fundamente conforme CLT, CF/88 e Súmula 443/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Estabilidades e garantias"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DAS ESTABILIDADES E GARANTIAS', abrangendo estabilidade gestante, acidentária, sindical, do reabilitado, do doente e da pré-aposentadoria. Estruture o texto com base nos documentos anexados (CAT, atestados, comunicações, CCT). Fundamente conforme CLT, CF/88, Lei 8.213/91 e jurisprudência consolidada do TST.",
    "artigosRelacionados": [
      "Art. 10, II, 'b', ADCT",
      "Arts. 471 e 543 da CLT",
      "Art. 118 e 93 da Lei 8.213/91",
      "Súmulas 244, 369, 378 e 443 do TST"
    ],
    "categoria": "Estabilidades e garantias"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a ausência de recolhimento de FGTS, indicando os meses não depositados, com base nos documentos anexados (extrato analítico da Caixa, contracheques, comunicações). Fundamente conforme Lei 8.036/90 e Súmula 461/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a ausência de recolhimento de INSS, informando os períodos trabalhados e os prejuízos previdenciários. Fundamente conforme Lei 8.212/91 e decisões do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "FGTS, multas e benefícios"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a ausência de fornecimento de vale-transporte e vale-alimentação durante o contrato, indicando valores médios e períodos. Fundamente conforme Lei 7.418/85 e CCT aplicável. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "FGTS, multas e benefícios"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático mencionando a existência de verbas rescisórias incontroversas não quitadas na primeira audiência, com base em recibos e documentos anexados. Fundamente conforme art. 467 da CLT e Súmula 69 do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "FGTS, multas e benefícios"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo o atraso no pagamento das verbas rescisórias, apontando as datas da dispensa e da quitação, com base nos comprovantes anexados. Fundamente conforme art. 477 da CLT e Súmula 350/TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "FGTS, multas e benefícios"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático descrevendo a não entrega das guias de seguro-desemprego, indicando as comunicações e prejuízos suportados pelo reclamante. Fundamente conforme Lei 7.998/90 e art. 477 da CLT. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "FGTS, multas e benefícios"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo completo 'DO FGTS, DAS MULTAS E DOS BENEFÍCIOS', abordando a ausência de depósitos fundiários e previdenciários, atraso de verbas rescisórias, não fornecimento de vales e multas legais. Estruture tecnicamente o texto conforme CLT, Leis 8.036/90, 8.212/91 e 7.418/85, com base nos documentos anexados (extratos, recibos, CCT). Mantenha linguagem forense técnica e impessoal.",
    "artigosRelacionados": [
      "Arts. 467 e 477 da CLT",
      "Lei 8.036/90 — FGTS",
      "Lei 8.212/91 — contribuições previdenciárias",
      "Lei 7.418/85 — vale-transporte",
      "Súmulas 69, 350 e 461 do TST"
    ],
    "categoria": "FGTS, multas e benefícios"
  },
  // ======================================
...

  {
    ...
    "promptSugestao": "Redija o trecho fático solicitando a concessão da justiça gratuita ao reclamante, informando sua situação de desemprego, ausência de renda e comprovantes anexados (holerites, extratos, declarações). Fundamente conforme CF/88, CLT e CPC. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
...

  {
    ...
    "promptSugestao": "Redija o trecho fático requerendo honorários advocatícios sucumbenciais, mencionando a atuação profissional do patrono e a previsão do art. 791-A da CLT. Fundamente conforme CPC e jurisprudência do TST. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Justiça gratuita e honorários"
  },

  {
    ...
    "promptSugestao": "Redija o trecho fático requerendo a inversão do ônus da prova técnica e a condenação da reclamada ao pagamento dos honorários periciais, conforme resultado da perícia e aplicação do art. 790-B da CLT. Fundamente de forma objetiva e técnica. O texto deve estar pronto para inserção em petição inicial, com linguagem técnica e forense, mantendo coesão, clareza e impessoalidade.",
    "categoria": "Justiça gratuita e honorários"
  },
  ...
  // ---------------------------------------------------------
  {
    "modeloGeral": "Redija o capítulo 'DA JUSTIÇA GRATUITA E DOS HONORÁRIOS', abordando a hipossuficiência do reclamante, o pedido de gratuidade, a fixação de honorários advocatícios e a responsabilidade pelos honorários periciais. Fundamente conforme CF/88, CLT, CPC e súmulas do TST, com base nos documentos anexados (declaração de pobreza, comprovantes de renda, procuração). Mantenha tom técnico e jurídico forense.",
    "artigosRelacionados": [
      "Arts. 790, 790-B e 791-A da CLT",
      "Art. 5º, LXXIV da CF/88",
      "Art. 98 do CPC",
      "Súmulas 219, 329, 457 e 463 do TST"
    ],
    "categoria": "Justiça gratuita e honorários"
  }
