// data/fatos-fundamentos-pedidos.js — versão enxuta e categorizada
// Campos mantidos: FFP[{fato,categoria,fundamentos[],pedidos[]}], PRELIMINARES[{titulo,fundamentoCurto,modelo}]
export const FFP = [
  {
  ...
  {
    "fato": "Teletrabalho / home office",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 75-A a 75-E — teletrabalho",
      "CLT art. 62, III — exceção de controle de jornada e seus limites",
      "Súmula 428/TST — sobreaviso por instrumentos telemáticos"
    ],
    "pedidos": [
      "Reconhecimento de jornada com controles efetivos",
      "Pagamento de horas extras e reflexos se houver controle ou metas com disponibilidade",
      "Reembolso de despesas de internet/energia e equipamentos, se comprovado pactuado ou necessário"
    ]
  },
  {
    "fato": "Banco de horas inválido",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 59, §§2º, 5º e 6º — banco de horas",
      "Súmula 85/TST — compensação de jornada"
    ],
    "pedidos": [
      "Pagamento das horas excedentes não compensadas como extras",
      "Anulação do banco de horas irregular com reflexos legais"
    ]
  },
  {
    "fato": "Cargo de confiança falso",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 62, II — cargo de confiança",
      "OJ 355/SDI-1/TST — gerente geral"
    ],
    "pedidos": [
      "Desenquadramento do art. 62, II",
      "Pagamento de horas extras e adicional de função quando devido"
    ]
  },
  {
    "fato": "Salário por fora / extrafolha",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 457 — parcelas salariais",
      "Art. 9º da CLT — nulidade de atos fraudulentos"
    ],
    "pedidos": [
      "Integração dos valores 'por fora' ao salário contratual com reflexos em férias + 1/3, 13º, FGTS e aviso-prévio"
    ]
  },
  {
    "fato": "Comissões não pagas / metas abusivas",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 457, §1º — comissões",
      "Súmula 340/TST — comissionista",
      "OJ 397/SDI-1/TST — divisor"
    ],
    "pedidos": [
      "Pagamento de comissões devidas com médias e reflexos",
      "Revisão de metas abusivas e diferenças decorrentes"
    ]
  },
  {
    "fato": "Gorjetas não repassadas",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 457, §§3º-6º — gorjeta"
    ],
    "pedidos": [
      "Pagamento das gorjetas não repassadas com reflexos legais"
    ]
  },
  {
    "fato": "Integração de verbas habituais",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 457 — natureza salarial",
      "Súmula 264/TST — média física",
      "Súmula 139/TST — adicional de insalubridade integra bases"
    ],
    "pedidos": [
      "Integração de verbas habituais (prêmios, adicionais) em DSR, 13º, férias + 1/3 e FGTS"
    ]
  },
  {
    "fato": "Intervalo interjornada insuficiente",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 66 — intervalo interjornada"
    ],
    "pedidos": [
      "Pagamento como extra do período suprimido entre jornadas, com reflexos"
    ]
  },
  {
    "fato": "Tempo à disposição (uniforme, revista, transporte interno, login)",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 4º — tempo à disposição",
      "Súmula 366/TST — tempo que antecede/sucede a jornada"
    ],
    "pedidos": [
      "Pagamento do tempo médio diário como extra, com reflexos"
    ]
  },
  {
    "fato": "Escala 12x36 inválida",
    "categoria": "Jornada de trabalho",
    "fundamentos": [
      "CLT art. 59-A — 12x36",
      "Súmula 444/TST — 12x36 antes da reforma"
    ],
    "pedidos": [
      "Pagamento de horas excedentes e feriados não compensados, se inválida a escala"
    ]
  },
  {
    "fato": "Adicional de transferência",
    "categoria": "Adicionais e condições",
    "fundamentos": [
      "CLT art. 469, §3º — adicional de transferência"
    ],
    "pedidos": [
      "Pagamento de adicional de 25% durante a transferência com mudança de domicílio"
    ]
  },
  {
    "fato": "Periculosidade de motociclista/entregador",
    "categoria": "Adicionais e condições",
    "fundamentos": [
      "CLT art. 193, §4º — periculosidade ao trabalhador em motocicleta",
      "Lei 12.997/2014"
    ],
    "pedidos": [
      "Pagamento do adicional de periculosidade com reflexos"
    ]
  },
  {
    "fato": "Insalubridade por agentes biológicos",
    "categoria": "Adicionais e condições",
    "fundamentos": [
    ...
    "pedidos": [
      "Pagamento do adicional de insalubridade no grau devido com reflexos"
    ]
  },
  {
    "fato": "Redução salarial ilícita / alteração lesiva",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CF/88 art. 7º, VI — irredutibilidade salarial",
      "CLT art. 468 — alteração contratual lesiva"
    ],
    "pedidos": [
      "Restabelecimento do salário/condições anteriores",
      "Pagamento das diferenças salariais com reflexos"
    ]
  },
  {
    "fato": "Transferência sem custeio",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 469 — transferência de empregado"
    ],
    "pedidos": [
      "Ressarcimento de despesas de mudança/diárias/ajuda de custo",
      "Adicional de transferência quando cabível"
    ]
  },
  {
    "fato": "PLR prometida e não paga",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "Lei 10.101/2000 — participação nos lucros e resultados"
    ],
    "pedidos": [
      "Pagamento da PLR conforme regulamento/acordo, sem natureza salarial"
    ]
  },
  {
    "fato": "Adicional de quebra de caixa",
    "categoria": "Adicionais e condições",
    "fundamentos": [
      "Normas coletivas aplicáveis",
      "Jurisprudência sobre natureza salarial do adicional"
    ],
    "pedidos": [
      "Pagamento do adicional de quebra de caixa com reflexos, se habitual"
    ]
  },
  {
    "fato": "Dano existencial por excesso de jornada",
    "categoria": "Danos morais e saúde",
    "fundamentos": [
      "CF/88 art. 1º, III e 5º, X — dignidade e dano moral",
      "CLT art. 6º — conciliação trabalho/vida"
    ],
    "pedidos": [
      "Indenização por dano existencial decorrente de jornada extenuante"
    ]
  },
  {
    "fato": "Contribuição assistencial/negocial indevida",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "Precedente STF temática 935 — liberdade de oposição",
      "Precedentes TST sobre desconto apenas autorizados"
    ],
    "pedidos": [
      "Restituição de descontos indevidos e abstenção de novas cobranças"
    ]
  },
  {
    "fato": "Despesas de trabalho não ressarcidas",
    "categoria": "Rescisão e verbas",
    "fundamentos": [
      "CLT art. 2º — riscos do empreendimento a cargo do empregador"
    ],
    "pedidos": [
      "Ressarcimento de despesas com ferramentas, celular, internet, combustível, quando exigidos pelo empregador"
    ]
  }
];
...
export const PRELIMINARES = [
  {
    ...
    "modelo": "Requer a concessão da justiça gratuita, nos termos do art. 5º, LXXIV, da CF/88, art. 98 do CPC e art. 790, §§ 3º e 4º, da CLT, em razão da hipossuficiência econômica do Reclamante, conforme declaração e documentos que instruem a inicial."
  },
  {
    "titulo": "Competência Territorial",
    "fundamentoCurto": "CLT art. 651",
    "modelo": "É competente este Juízo, pois o local da prestação de serviços foi nesta circunscrição, nos termos do art. 651 da CLT."
  },
  {
    "titulo": "Competência Material",
    "fundamentoCurto": "CF/88 art. 114",
    "modelo": "A matéria versa sobre relação de trabalho, atraindo a competência material da Justiça do Trabalho, na forma do art. 114 da Constituição Federal."
  },
  {
    "titulo": "Segredo de Justiça (dados sensíveis)",
    "fundamentoCurto": "CPC art. 189, I; LGPD",
    "modelo": "Requer-se segredo de justiça, haja vista a presença de dados sensíveis/íntimos constantes dos autos, nos termos do art. 189, I, do CPC, sem prejuízo da tutela de dados pessoais."
  },
  {
    "titulo": "Prioridade de Tramitação",
    "fundamentoCurto": "Lei 10.741/03; CPC art. 1.048",
    "modelo": "Tendo o Reclamante direito à prioridade de tramitação (idade/saúde), requer-se a observância preferencial do feito, consoante art. 1.048 do CPC e legislação aplicável."
  },
  {
    "titulo": "Tutela de Urgência",
    "fundamentoCurto": "CPC arts. 300-301; CLT art. 300 por remissão",
    "modelo": "Diante do perigo de dano e da probabilidade do direito, requer-se tutela de urgência consistente em [especificar], nos termos dos arts. 300 e 301 do CPC."
  },
  {
    "titulo": "Intimações em Nome do Advogado",
    "fundamentoCurto": "CPC art. 272, §5º",
    "modelo": "Requerem-se as intimações exclusivamente em nome do advogado [NOME], OAB/[UF] [NÚMERO], sob pena de nulidade, nos termos do art. 272, §5º, do CPC."
  },
  {
    "titulo": "Produção de Provas",
    "fundamentoCurto": "CLT art. 818; CPC arts. 369 e segs.",
    "modelo": "Requer a produção de todas as provas em direito admitidas, em especial documental, testemunhal e pericial, se necessária, nos termos da CLT e do CPC."
  },
  {
    "titulo": "Citação/Notificação Eletrônica",
    "fundamentoCurto": "CPC art. 246; atos normativos do TRT",
    "modelo": "Requer-se a citação/notificação eletrônica da Reclamada no endereço constante do cadastro e nos termos da regulamentação do E-Proc/TrT competente."
  },
  {
    "titulo": "Distribuição por Dependência (se houver conexão)",
    "fundamentoCurto": "CPC arts. 55 e 286",
    "modelo": "Requer-se a distribuição por dependência ao processo nº [indicar], por conexão/continência, para evitar decisões conflitantes, conforme arts. 55 e 286 do CPC."
  }
];
